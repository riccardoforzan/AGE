...
This version of the script only extract unique values for the fields `literals, classes, entities , properties`
"""
    ...
    with open(metadata_file, "r+") as f:
        ...
        for file in usable_files:
            try:
                ...
                classes = classes.union(data["classes"])
                literals = literals.union(data["literals"])
                entities = entities.union(data["entities"])
                properties = properties.union(data["properties"])
        ...
        metadata["literals"] = list(literals)
